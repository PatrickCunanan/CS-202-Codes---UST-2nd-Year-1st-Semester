...
public class Subtraction extends Main {
     ...
     */
    static void SubtractActionPerformed (ActionEvent a) throws Exception{
       JF.setSize(600,350);
       ...
       result = new JLabel("Subtraction of Matrix:");
       result.setBounds(400, 5, 200, 30);
       
       plus = new JLabel("-");
       plus.setBounds(175,100,16,150);
       ...
       addmatrix = new JButton("Subtract Matrices"); 
       addmatrix.setBackground(SystemColor.textHighlightText);
       addmatrix.setFont(new Font("Arial Black", Font.PLAIN, 8));
