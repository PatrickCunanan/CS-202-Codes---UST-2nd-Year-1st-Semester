...
public class Multiplication extends Main {
    ...
    static String num1[][], num2[][], multiply[][];
    
    /**
     * @wbp.parser.entryPoint
     */
    static void MultiplyActionPerformed (ActionEvent a) throws Exception{
       JF.setSize(600,350);
       ...
       addmatrix = new JButton("Multiply"); 
       addmatrix.setBackground(SystemColor.text);
       ...
       clear.setBackground(SystemColor.text);
       ...
       JF.getContentPane().add(btnmatrix1);      JF.getContentPane().add(lblmatrix1);     JF.getContentPane().add(plus);
       ...
       JF.getContentPane().add(row2);            JF.getContentPane().add(mtrx3);
       JF.getContentPane().add(col1);            JF.getContentPane().add(col2);           JF.getContentPane().add(mtrx2);
       JF.getContentPane().add(mtrx1);           JF.getContentPane().add(p1);              JF.getContentPane().add(p2);
              
              result = new JLabel("Multiplication of Matrix:");
              result.setHorizontalAlignment(SwingConstants.CENTER);
              result.setBounds(0, 0, 243, 30);
              p2.add(result);
       ...
       static public class getResult implements ActionListener{
           public void actionPerformed(ActionEvent ae){
                       ...
                       for (int j =0; j<mr1; j++ )
                       {
                            for (int k = 0; k<mc2; k++)
                            {
                                  for (int l =0; l<mc1; l++)
                                  {
                                	  ...
                                	  x = Integer.parseInt(num1[j][k]) * Integer.parseInt(num2[l][k]);
                                      y = y+x;
                                  }
                                  String results = Integer.toString(y);                                               
                   ...
                   JOptionPane.showMessageDialog(JF, "The n size of the first matrix must be equal to the m size of the second matrix", "error", JOptionPane.ERROR_MESSAGE);
       }
    }
